...
function Sidebar({sideNavbar}){
    return(
        <>
        <div className={sideNavbar ? "home-sidebar flex flex-col flex-grow-[0.16] flex-shrink box-border h-[95vh] overflow-y-auto fixed t-[55px] left-0 w-[40vw] p-[14px] pt-5 sm:w-[20vw]  md:pt-[50px] lg:pt-2 bg-black text-white":"home-sidebarhide hidden "}>
